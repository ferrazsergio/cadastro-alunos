...
public interface AlunoRepository extends JpaRepository<Aluno, String> {
     ...
     */
    @Query("SELECT CASE WHEN COUNT(a) > 0 THEN true ELSE false END FROM Aluno a WHERE a.cpf = :cpf AND a.turma <> :turma")
    boolean isCpfRegisteredInDifferentTurma(@Param("cpf") String cpf, @Param("turma") String turma);
